...
//        msgContent.setUserInfo(SaveUserInfo.getUserInfo());
        ...
        RongIMClient.getInstance().sendMessage(msg, null, null, new RongIMClient.SendMessageCallback() {
            ...
            public void onSuccess(Integer integer) {
                ...
                Log.d("LiveChatFragment", "sendonSuccess ");
            }
            ...
            public void onSuccess(Message message) {
                Log.d("LiveChatFragment", "ResultonSuccess ");
            }

            @Override
            public void onError(RongIMClient.ErrorCode e) {
                Log.d("LiveChatFragment", "ResultonErrorCode ");
            }
        });
    }
