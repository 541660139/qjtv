...
public class ZQRefreshLayout extends ViewGroup {
    ...
    private SwipeProgressBar mProgressBar; //滑动进度条
...
//            }  
    ...
    public ZQRefreshLayout(Context context) {
        this(context, null);
    }


    public ZQRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        }  
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == mActivePointerId) {
            // This was our active pointer going up. Choose a new_pic
