...
public class AutoScrollTv extends TextView implements Runnable {
    ...
    private int mMarqueeRepeatLimit = 10;
    private int mMarqueeVelocity = 2;

    private OnMarqueeCompleteListener marqueeCompleteListener;

    public AutoScrollTv(Context context) {
        this(context, null);
    }

    public AutoScrollTv(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoScrollTv(Context context, AttributeSet attrs, int defStyle) {
