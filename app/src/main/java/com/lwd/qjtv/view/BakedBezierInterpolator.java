...
public class BakedBezierInterpolator implements Interpolator {
    ...
    private static BakedBezierInterpolator bakedBezierInterpolator;

    public static BakedBezierInterpolator getInstance() {
        if (bakedBezierInterpolator == null)
            bakedBezierInterpolator = new BakedBezierInterpolator();
        return bakedBezierInterpolator;
    }
