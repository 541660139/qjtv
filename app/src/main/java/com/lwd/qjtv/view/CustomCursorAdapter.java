...
import com.lwd.qjtv.mvp.ui.callback.CursorDeleteCallback;
...
public class CustomCursorAdapter extends SimpleCursorAdapter {
    ...
    private CursorDeleteCallback cursorDeleteCallback;
     ...
     * {@link SimpleCursorAdapter.ViewBinder#setViewValue(android.view.View, android.database.Cursor, int)}
     ...
     * @see #getViewBinder()
     * @see #setViewBinder(SimpleCursorAdapter.ViewBinder)
            ...
            if (v != null) {
                ...
                if (!bound) {
                    ...
                    if (v instanceof TextView) {
                        ...
                        setViewImage((ImageView) v, text, cursor, i);
                    } else {
    ...
    /**
     * Returns the {@link SimpleCursorAdapter.ViewBinder} used to bind data to views.
     *
     ...
     */
    public void setViewImage(ImageView v, String value, Cursor cursor, int position) {
        try {
            v.setImageResource(Integer.parseInt(value));
            if ("R.id.search_delete_iv".equals(value)) {
                v.setOnClickListener(view -> cursorDeleteCallback.deleteItem(cursor, position));
            }
    ...
    public void setCursorDeleteCallback(CursorDeleteCallback cursorDeleteCallback) {
     ...
     * @see #setCursorToStringConverter(SimpleCursorAdapter.CursorToStringConverter)
