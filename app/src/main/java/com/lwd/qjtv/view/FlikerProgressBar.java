...
//    private PorterDuffXfermode xfermode = new_pic PorterDuffXfermode(PorterDuff.Mode.SRC_ATOP);
//
...
//
//    private void init() {
//        bgPaint = new_pic Paint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
//        bgPaint.setStyle(Paint.Style.STROKE);
//        bgPaint.setStrokeWidth(borderWidth);
//
//        pgPaint = new_pic Paint(Paint.ANTI_ALIAS_FLAG);
//        pgPaint.setStyle(Paint.Style.FILL);
//
//        textPaint = new_pic Paint(Paint.ANTI_ALIAS_FLAG);
//        textPaint.setTextSize(textSize);
//
//        textRect = new_pic Rect();
//        bgRectf = new_pic RectF(borderWidth, borderWidth, getMeasuredWidth() - borderWidth, getMeasuredHeight() - borderWidth);
//
//        if(isStop){
...
//        pgCanvas = new_pic Canvas(pgBitmap);
//        thread = new_pic Thread(this);
//        thread.start();
//    }
//
//
...
//
//        //控制显示区域
//        bitmapShader = new_pic BitmapShader(pgBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
