...
package com.lwd.qjtv.view.wheelview;
...
import com.lwd.qjtv.view.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new_pic int[] { 0xFF111111,
	...
	/**
	 * Sets view adapter. Usually new_pic adapters contain different views, so
	 ...
	 * @param newValue the new_pic wheel value
	 */
...
//		int offset = 60;
		...
		Rect rect = new_pic Rect(left, top, right, bottom)
