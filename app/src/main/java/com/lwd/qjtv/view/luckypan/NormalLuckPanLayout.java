 ...
 * 邮箱：nipuream@163.com
 */
public class NormalLuckPanLayout extends RelativeLayout {
    ...
    private NormalRotatePan rotatePan;
    ...
    public NormalLuckPanLayout(Context context) {
        this(context,null);
    }

    public NormalLuckPanLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public NormalLuckPanLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        yellowPaint.setColor(Color.rgb(213, 141, 245));
        whitePaint.setColor(Color.WHITE);
        backgroundPaint.setColor(Color.rgb(44, 27, 109));
...
//        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for(int i=0;i<getChildCount();i++){
            ...
            if(child instanceof NormalRotatePan){
                rotatePan = (NormalRotatePan) child;
        ...
        if(!panReady) throw new RuntimeException("Have you add NormalRotatePan in NormalLuckPanLayout element ?");
    }
