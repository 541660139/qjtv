...
@ActivityScope
public class MatchCollectionDetailsModel extends BaseModel implements MatchCollectionDetailsContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MatchCollectionDetailsModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
