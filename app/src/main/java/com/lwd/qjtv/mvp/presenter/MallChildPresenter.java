...
@ActivityScope
public class MallChildPresenter extends BasePresenter<MallChildContract.Model, MallChildContract.View> {
    ...
    @Inject
    public MallChildPresenter(MallChildContract.Model model, MallChildContract.View rootView
    ...
    public void requestMallList(final boolean pullToRefresh, String order) {
        if (mAdapter == null) {
