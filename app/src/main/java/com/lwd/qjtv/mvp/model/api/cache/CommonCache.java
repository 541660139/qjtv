package com.lwd.qjtv.mvp.model.api.cache;
...
public interface CommonCache {
    ...
    @LifeCache(duration = 2, timeUnit = TimeUnit.MINUTES)
    Observable<Reply<LearnBallBean>> getLearnBall(Observable<LearnBallBean> datas, DynamicKey idLastUserQueried,  EvictProvider evictProvider);
}
