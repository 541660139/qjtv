...
@ActivityScope
public class NBAGuessCenterModel extends BaseModel implements NBAGuessCenterContract.Model {
    @Inject
    public NBAGuessCenterModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }


    @Override
    public Observable<GuessCenterBean> getNBAGuessCenter(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getNBAGuessCenter(map);
    }
