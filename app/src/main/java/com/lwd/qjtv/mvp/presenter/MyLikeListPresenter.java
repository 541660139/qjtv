...
@ActivityScope
public class MyLikeListPresenter extends BasePresenter<MyLikeListContract.Model, MyLikeListContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;
    private List<MyLikeListBean.DataBean.AvaterBean> mList = new ArrayList<>();
    ...
    @Inject
    public MyLikeListPresenter(MyLikeListContract.Model model, MyLikeListContract.View rootView
    ...
    public void getMyCommentList(final boolean pullToRefresh) {
        if (mAdapter == null) {
            mAdapter = new MyLikeItemAdapter(mList);
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getLikeList(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<MyLikeListBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull MyLikeListBean list) {
                        ...
                        List<MyLikeListBean.DataBean.AvaterBean> data = list.getData().getAvater();
