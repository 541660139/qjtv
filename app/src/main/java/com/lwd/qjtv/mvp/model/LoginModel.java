...
public class LoginModel extends BaseModel implements LoginContract.Model {
    ...
    @Override
    public Observable<LoginBean> login( @QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).login(map);
    }

    @Override
    public Observable<GetToken> getToken(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getToken(map);
    }
