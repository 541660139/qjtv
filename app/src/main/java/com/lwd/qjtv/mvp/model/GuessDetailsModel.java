...
@ActivityScope
public class GuessDetailsModel extends BaseModel implements GuessDetailsContract.Model {
    @Inject
    public GuessDetailsModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }


    @Override
    public Observable<GuessDetailsBean> getGuessDetails( @QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getGuessDetails( map);
    }
