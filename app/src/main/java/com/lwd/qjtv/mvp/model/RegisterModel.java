...
public class RegisterModel extends BaseModel implements RegisterContract.Model {
    ...
    @Override
    public Observable<BaseBean> sendMsg( @QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).sendMsg(map);
    }

    @Override
    public Observable<RegisterBean> register(@QueryMap Map<String, String> map) {
