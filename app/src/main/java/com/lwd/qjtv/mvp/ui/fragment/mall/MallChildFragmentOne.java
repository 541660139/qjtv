...
import com.lwd.qjtv.di.component.DaggerMallChildOneComponent;
...
public class MallChildFragmentOne extends BaseFragment<MallChildPresenter> implements MallChildContract.View ,OnRefreshListener,OnLoadmoreListener {
    ...
    public static MallChildFragmentOne newInstance() {
        MallChildFragmentOne fragment = new MallChildFragmentOne();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerMallChildOneComponent
                .builder()
    ...
    public void initData() {
        mPresenter.requestMallList(true,"2");
//        UiUtils.configRecycleView(recyclerView,new_pic LinearLayoutManager(getContext()));
//        recyclerView.setAdapter(new_pic MallAdapter(null));
    }
...
//        initPaginate();
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        mPresenter.requestMallList(false,"2");
    }
