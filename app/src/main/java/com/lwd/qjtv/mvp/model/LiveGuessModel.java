...
@ActivityScope
public class LiveGuessModel extends BaseModel implements LiveGuessContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public LiveGuessModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
