...
@FragmentScope
public class WatchingFocusPresenter extends BasePresenter<WatchingFocusContract.Model, WatchingFocusContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;
    private List<HotPointBean.DataBean> mList = new ArrayList<>();
    ...
    @Inject
    public WatchingFocusPresenter(WatchingFocusContract.Model model, WatchingFocusContract.View rootView
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getHotPoint(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<HotPointBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull HotPointBean list) {
                        ...
                        List<HotPointBean.DataBean> data = list.getData();
