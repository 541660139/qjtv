...
public class VideoDetailsModel extends BaseModel implements VideoDetailsContract.Model {
    ...
    @Inject
    public VideoDetailsModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<VideoDetailsNewBean> getVideoDetailsNew(@QueryMap Map<String, String> map) {
        Observable<VideoDetailsNewBean> videoDetails = mRepositoryManager.obtainRetrofitService(UserService.class)
                .getVideoDetailsNew(map);
    ...
    @Override
    public Observable<BaseBean> setCollect(@QueryMap Map<String, String> map) {
        Observable<BaseBean> stringObservable = mRepositoryManager.obtainRetrofitService(UserService.class)
                .setCollect(map);
    ...
    @Override
    public Observable<DianZanBean> likeVideo(@QueryMap Map<String, String> map) {
        Observable<DianZanBean> stringObservable = mRepositoryManager.obtainRetrofitService(UserService.class)
                .setDianZan(map);
        return stringObservable;
    }
