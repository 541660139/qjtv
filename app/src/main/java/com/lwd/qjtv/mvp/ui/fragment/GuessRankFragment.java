...
import com.lwd.qjtv.di.component.DaggerGuessRankComponent;
...
import com.lwd.qjtv.mvp.presenter.GuessRankPresenter;
...
public class GuessRankFragment extends BaseFragment<GuessRankPresenter> implements GuessRankContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static GuessRankFragment newInstance() {
        GuessRankFragment fragment = new GuessRankFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerGuessRankComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .guessRankModule(new GuessRankModule(this))
                .build()
                .inject(this);
    }
    ...
    public View initView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_guess_rank, container, false);
    }
