...
public class BetModelBean {
    ...
    @Generated(hash = 1479701102)
    public BetModelBean() {
    }

    @Generated(hash = 1521389040)
    public BetModelBean(long id, String match_id, String jc_id, String jc_pl_id, String jc_type, String left_pic, String right_pic, String left_name, String right_name, String jc_name, String jc_peilv, String match_name, String over_time) {
        this.id = id;
