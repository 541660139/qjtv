...
import com.lwd.qjtv.di.component.DaggerGuessMoreComponent;
import com.lwd.qjtv.di.module.GuessMoreModule;
import com.lwd.qjtv.mvp.contract.GuessMoreContract;
import com.lwd.qjtv.mvp.presenter.GuessMorePresenter;
...
public class GuessMoreFragment extends BaseFragment<GuessMorePresenter> implements GuessMoreContract.View, OnRefreshListener,OnLoadmoreListener {
    ...
    public static GuessMoreFragment newInstance() {
        GuessMoreFragment fragment = new GuessMoreFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerGuessMoreComponent
                .builder()
                .appComponent(appComponent)
                .guessMoreModule(new GuessMoreModule(this))//请将GuessMoreModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    public void initData() {
        ...
        mPresenter.requestGuessMoreList(true);//打开app时自动加载列表
    }
...
//        initPaginate();
        ...
        if (mPaginate == null) {
            Paginate.Callbacks callbacks = new Paginate.Callbacks() {
                ...
                public void onLoadMore() {
                    mPresenter.requestGuessMoreList(false);
                }
    ...
    public void onRefresh(RefreshLayout refreshlayout) {
        mPresenter.requestGuessMoreList(true);
    }
}