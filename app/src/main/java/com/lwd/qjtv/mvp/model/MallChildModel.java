...
@ActivityScope
public class MallChildModel extends BaseModel implements MallChildContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MallChildModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    public Observable<MallListBean> getMall(Map<String,String> map) {
        Observable<MallListBean> list = mRepositoryManager.obtainRetrofitService(UserService.class)
                .getMall(map);
