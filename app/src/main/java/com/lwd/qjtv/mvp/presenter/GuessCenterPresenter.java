...
@ActivityScope
public class GuessCenterPresenter extends BasePresenter<GuessCenterContract.Model, GuessCenterContract.View> {
    ...
    @Inject
    public GuessCenterPresenter(GuessCenterContract.Model model, GuessCenterContract.View rootView, RxErrorHandler handler
    ...
    public void requestGuessCenterList(final boolean pullToRefresh) {
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getGuessCenter(map), pullToRefresh)
