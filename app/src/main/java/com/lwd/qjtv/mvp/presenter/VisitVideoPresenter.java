...
@ActivityScope
public class VisitVideoPresenter extends BasePresenter<VisitVideoContract.Model, VisitVideoContract.View> {
    ...
    @Inject
    public VisitVideoPresenter(VisitVideoContract.Model model, VisitVideoContract.View rootView, RxErrorHandler handler
