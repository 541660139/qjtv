...
@ActivityScope
public class CommentMessagePresenter extends BasePresenter<CommentMessageContract.Model, CommentMessageContract.View> {
...
//    private DefaultAdapter mAdapter;
    ...
    @Inject
    public CommentMessagePresenter(CommentMessageContract.Model model, CommentMessageContract.View rootView, RxErrorHandler handler
