...
import com.lwd.qjtv.mvp.ui.adapter.MyOrderAdapter;
...
public class MyOrderPresenter extends BasePresenter<MyOrderContract.Model, MyOrderContract.View> {
    ...
    @Inject
    public MyOrderPresenter(MyOrderContract.Model model, MyOrderContract.View rootView, RxErrorHandler handler
    ...
    public void requestMyOrderList(final boolean pullToRefresh) {
        if (mAdapter == null) {
