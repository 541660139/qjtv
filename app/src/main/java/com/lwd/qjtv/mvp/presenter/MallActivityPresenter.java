...
@ActivityScope
public class MallActivityPresenter extends BasePresenter<MallActivityContract.Model, MallActivityContract.View> {
    ...
    @Inject
    public MallActivityPresenter(MallActivityContract.Model model, MallActivityContract.View rootView
