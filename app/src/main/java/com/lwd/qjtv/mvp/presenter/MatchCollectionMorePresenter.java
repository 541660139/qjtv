...
import com.lwd.qjtv.mvp.ui.adapter.MatchCollectionMoreAdapter;
...
@ActivityScope
public class MatchCollectionMorePresenter extends BasePresenter<MatchCollectionMoreContract.Model, MatchCollectionMoreContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;
    private List<MatchCollectionMoreBean.DataBean> mList = new ArrayList<>();
    ...
    @Inject
    public MatchCollectionMorePresenter(MatchCollectionMoreContract.Model model, MatchCollectionMoreContract.View rootView
    ...
    public void getMatchCollectionMoreList(boolean pullToRefresh) {
        if (mAdapter == null) {
            mAdapter = new MatchCollectionMoreAdapter(mList);
        ...
        RxUtils.applyListSchedulers(mRootView,mModel.getMatchCollection(map),pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<MatchCollectionMoreBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull MatchCollectionMoreBean list) {
                        ...
                        List<MatchCollectionMoreBean.DataBean> data = list.getData();
