...
public class SnookerJCFragment extends com.jess.arms.base.BaseFragment implements OnRefreshListener, OnLoadmoreListener {
    ...
    private void initListener() {
        ...
        activity_guess_center_my_guess_ll.setOnClickListener(view -> startActivity(new Intent(WEApplication.getContext(), MyGuessActivity.class)));
    ...
    private void initGuessCenterData() {
        ...
        appComponent.repositoryManager().obtainRetrofitService(UserService.class).getGuessCenter(map)
