...
public class MoreVideoItemHolder extends BaseHolder<MoreVideoBean.DataBean> {
    ...
    public MoreVideoItemHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void setData(MoreVideoBean.DataBean data, int position) {
        scoreTv.setVisibility((data.getScore() == null || data.getScore().equals("") || data.getScore().equals("0")) ? View.GONE : View.VISIBLE);
        scoreTv.setText(scoreTv.getVisibility() == View.VISIBLE ? data.getScore() : "");
