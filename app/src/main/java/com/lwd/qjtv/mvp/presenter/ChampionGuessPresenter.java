...
import com.lwd.qjtv.mvp.ui.adapter.ChampionGuessAdapter;
...
@ActivityScope
public class ChampionGuessPresenter extends BasePresenter<ChampionGuessContract.Model, ChampionGuessContract.View> {
    private RxErrorHandler mErrorHandler;
    private AppManager mAppManager;
    private Application mApplication;
    private List<ChampionGuess.DataBean> mList = new ArrayList<>();
    ...
    @Inject
    public ChampionGuessPresenter(ChampionGuessContract.Model model, ChampionGuessContract.View rootView, RxErrorHandler handler
    ...
    public void requestChampionGuessList(final boolean pullToRefresh) {
        if (mAdapter == null) {
            mAdapter = new ChampionGuessAdapter(mList);
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getChampionGuess(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<ChampionGuess>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull ChampionGuess t) {
                        ...
                        List<ChampionGuess.DataBean> list = t.getData();
