...
public class MoreModel extends BaseModel implements MoreContract.Model {
    @Inject
    public MoreModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }


    @Override
    public Observable<MoreTeachListBean> getMoreTeachListVideo(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getMoreTeachListVideo(map);
    }
}
