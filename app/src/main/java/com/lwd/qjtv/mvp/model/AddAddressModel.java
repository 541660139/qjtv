...
public class AddAddressModel extends BaseModel implements AddAddressContract.Model {
    ...
    @Override
    public Observable<AddAddressBean> addAddress(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).addAddress(map);
    }

    @Override
    public Observable<AddAddressBean> changeAddress(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).addAddress(map);
    }
}