...
public class UserInfoModel extends BaseModel implements UserInfoContract.Model {
    ...
    @Override
    public Observable<ChangeNameBean> changeName(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).changeName(map);
    }
