...
@ActivityScope
public class WebAddressPresenter extends BasePresenter<WebAddressContract.Model, WebAddressContract.View> {
    ...
    @Inject
    public WebAddressPresenter(WebAddressContract.Model model, WebAddressContract.View rootView, RxErrorHandler handler
    ...
    public void requestWebAddressList(final boolean pullToRefresh) {
        if (mAdapter == null) {
            mAdapter = new WebAddressAdapter(mList);
