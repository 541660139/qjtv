...
public class RankModel extends BaseModel implements RankContract.Model {
    ...
    @Override
    public Observable<GuessRankBean> guessNBARank(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).guessNBARank(map);
    }
}
