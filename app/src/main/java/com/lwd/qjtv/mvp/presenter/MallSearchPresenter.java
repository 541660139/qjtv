...
import com.lwd.qjtv.mvp.ui.adapter.MallSearchAdapter;
...
@ActivityScope
public class MallSearchPresenter extends BasePresenter<MallSearchContract.Model, MallSearchContract.View> {
    private RxErrorHandler mErrorHandler;
    private AppManager mAppManager;
    private Application mApplication;
    private List<SearchMallBean.DataBean> mList = new ArrayList<>();
    ...
    @Inject
    public MallSearchPresenter(MallSearchContract.Model model, MallSearchContract.View rootView, RxErrorHandler handler
    ...
    public void requestMallSearchList(final boolean pullToRefresh, String word) {
        if (mAdapter == null) {
            mAdapter = new MallSearchAdapter(mList);
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getSearchMall(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<SearchMallBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull SearchMallBean t) {
                        ...
                        List<SearchMallBean.DataBean> data = t.getData();
