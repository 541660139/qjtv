...
@ActivityScope
public class NBAGuessDetailsPresenter extends BasePresenter<NBAGuessDetailsContract.Model, NBAGuessDetailsContract.View> {
    ...
    @Inject
    public NBAGuessDetailsPresenter(NBAGuessDetailsContract.Model model, NBAGuessDetailsContract.View rootView
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getNBAGuessDetails(map), pullToRefresh)
