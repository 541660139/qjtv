...
import com.lwd.qjtv.di.component.DaggerMallChildComponent;
...
public class MallChildFragment extends BaseFragment<MallChildPresenter> implements MallChildContract.View, OnRefreshListener, OnLoadmoreListener {
    ...
    public static MallChildFragment newInstance(String order) {
        MallChildFragment fragment = new MallChildFragment();
        Bundle bundleOne = new Bundle();
        bundleOne.putString("order", order);
    ...
    public void initData() {
        ...
        mPresenter.requestMallList(true, order);
        initListener();
    }

    private void initListener() {
        loadingPageView.setClickReload(() -> mPresenter.requestMallList(true, order));
...
//        mSwipeRefreshLayout.setOnRefreshListener(this);
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        mPresenter.requestMallList(false, order);
    }
