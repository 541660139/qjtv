...
import com.lwd.qjtv.di.component.DaggerGuessDetailsComponent;
import com.lwd.qjtv.di.module.GuessDetailsModule;
...
public class GuessDetailsActivity extends BaseActivity<GuessDetailsPresenter> implements GuessDetailsContract.View, SwipeRefreshLayout.OnRefreshListener, GuessDetailsNumAdapter.CallBackChooseItem {
    ...
    TextView gameNumTv;
    @BindView(R.id.activity_guess_details_rangfen_tv)
    TextView rangfenTv;
    @BindView(R.id.fragment_live_guess_rangfen_recyclerview)
    RecyclerView rangfenRecyclerView;
    //竞猜id
...
//                    showMessage("删除多选成功");
    ...
    public void setupActivityComponent(AppComponent appComponent) {
        ...
        DaggerGuessDetailsComponent
                .builder()
                .appComponent(appComponent)
                .guessDetailsModule(new GuessDetailsModule(this))  //首字母改成小写
                .build()
                .inject(this);
    }
    ...
    @Override
    public int initView() {
        return R.layout.activity_guess_details_layout;
    }
...
//        UiUtils.configRecycleView(rangfenRecyclerView, new GridLayoutManager(this, 2));
    }
...
//        UiUtils.SnackbarText(message);
    ...
    public void setData(Object o) {
        ...
        if (((GuessDetailsBean.DataBean) o).getGuess_rangfen().getPlInfo().size() == 0)
            rangfenTv.setVisibility(View.GONE);
        detailsInfo(dataBean);
        winMod(dataBean);
        guessMod(dataBean);
        guessRangfen(dataBean);
        initDao();
        ...
        b.setApiparm(title, this.o.getGuess_detail().getMatch_id() + "", this.o.getGuess_rangfen().getJc_type(), this.o.getGuess_rangfen().getId());
        chargeTv.setText("多选车(" + getSize() + ")");
    }

    private void guessRangfen(GuessDetailsBean.DataBean dataBean) {
        UiUtils.configRecycleView(rangfenRecyclerView, new GridLayoutManager(this, 2));
        b = new GuessRangFenAdapter(dataBean.getGuess_rangfen().getPlInfo());
        rangfenRecyclerView.setAdapter(b);
//        initRecycleView();
    }
...
//            showMessage("加入多选成功");
    ...
    private void showMoreBetDialog() {
        if (Preference.getBoolean(Constant.IS_MORE_BET_TIP, true))
            new MoreBetTipDialog(this).show();
    }
