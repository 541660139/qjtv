...
public abstract class RecyclerViewCursorAdapter<VH extends RecyclerView.ViewHolder>
    ...
    /**
     * Change the underlying cursor to a new_pic cursor. If there is an existing cursor it will be
     * closed.
     *
     * @param cursor The new_pic cursor to be used
     */
    ...
    /**
     * Swap in a new_pic Cursor, returning the old Cursor.  Unlike
     * {@link #changeCursor(Cursor)}, the returned old Cursor is <em>not</em>
     * closed.
     *
     * @param newCursor The new_pic cursor to be used.
     *
     * @return Returns the previously set Cursor, or null if there wasa not one.
     * If the given new_pic Cursor is the same instance is the previously set
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            mDataValid = true;
            // notify the observers about the new_pic cursor
...
//            notifyDataSetInvalidated();
     ...
     *
     * @return a Cursor representing the results of the new_pic query
     *
     * @see #getFilter()
