...
@ActivityScope
public class LiveGuessPresenter extends BasePresenter<LiveGuessContract.Model, LiveGuessContract.View> {
    ...
    @Inject
    public LiveGuessPresenter(LiveGuessContract.Model model, LiveGuessContract.View rootView
