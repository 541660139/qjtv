...
@FragmentScope
public class GuessRankPresenter extends BasePresenter<GuessRankContract.Model, GuessRankContract.View> {
    @Inject
    ...
    @Inject
    public GuessRankPresenter(GuessRankContract.Model model, GuessRankContract.View rootView) {
