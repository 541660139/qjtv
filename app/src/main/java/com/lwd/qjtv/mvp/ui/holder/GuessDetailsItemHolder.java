...
public class GuessDetailsItemHolder extends BaseHolder<GuessDetailsBean.DataBean.GuessScoreBean.PlInfoBeanXX> {
    ...
    public GuessDetailsItemHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void setData(GuessDetailsBean.DataBean.GuessScoreBean.PlInfoBeanXX leftWinBean, int position) {
