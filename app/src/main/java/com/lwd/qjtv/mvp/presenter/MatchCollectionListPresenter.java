...
import com.lwd.qjtv.mvp.ui.adapter.MatchCollectionListAdapter;
...
@ActivityScope
public class MatchCollectionListPresenter extends BasePresenter<MatchCollectionListContract.Model, MatchCollectionListContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;
    private List<MatchCollectionNewListBean.DataBeanX.MatchListBean> mList = new ArrayList<>();
    ...
    @Inject
    public MatchCollectionListPresenter(MatchCollectionListContract.Model model, MatchCollectionListContract.View rootView
    ...
    public void getMatchCollectionList(final boolean pullToRefresh,String id) {
        if (mAdapter == null) {
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getMatchCollectionList(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<MatchCollectionNewListBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull MatchCollectionNewListBean list) {
                        ...
                        List<MatchCollectionNewListBean.DataBeanX.MatchListBean> data = list.getData().getMatch_list();
