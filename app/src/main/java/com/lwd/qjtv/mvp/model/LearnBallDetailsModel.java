...
@ActivityScope
public class LearnBallDetailsModel extends BaseModel implements LearnBallDetailsContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public LearnBallDetailsModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<VideoDetailsBean> getVideoDetails(@QueryMap Map<String, String> map) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getVideoDetails(map);
    }
