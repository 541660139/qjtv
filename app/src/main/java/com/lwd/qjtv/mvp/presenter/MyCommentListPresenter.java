...
import com.lwd.qjtv.mvp.ui.adapter.MyCommentItemAdapter;
...
public class MyCommentListPresenter extends BasePresenter<MyCommentListContract.Model, MyCommentListContract.View> {
    ...
    private List<MyCommentListBean.DataBean> mList = new ArrayList<>();
    ...
    @Inject
    public MyCommentListPresenter(MyCommentListContract.Model model, MyCommentListContract.View rootView
    ...
    public void getMyCommentList(final boolean pullToRefresh) {
        if (mAdapter == null) {
            mAdapter = new MyCommentItemAdapter(mList);
...
//        }, mRootView.getRxPermissions(), mRootView, mErrorHandler);
        ...
        RxUtils.applyListSchedulers(mRootView, mModel.getCommentList(map), pullToRefresh)
                .subscribe(new ErrorHandleSubscriber<MyCommentListBean>(mErrorHandler) {
                    @Override
                    public void onNext(@NonNull MyCommentListBean list) {
                        ...
                        List<MyCommentListBean.DataBean> data = list.getData();
