...
@ActivityScope
@Component(modules = StarDetailsModule.class, dependencies = AppComponent.class)
public interface StarDetailsComponent {
    void inject(StarDetailsActivity activity);
}