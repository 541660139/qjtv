...
import com.lwd.qjtv.mvp.model.PaySuccessModel;
...
public class PaySuccessModule {
    ...
    /**
     * 构建PaySuccessModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    PaySuccessContract.Model providePaySuccessModel(PaySuccessModel model) {
        return model;
    }
}