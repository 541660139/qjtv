...
@ActivityScope
@Component(modules = PersonalWarehouseModule.class, dependencies = AppComponent.class)
public interface PersonalWarehouseComponent {
    void inject(PersonalWarehouseActivity activity);
}