...
@ActivityScope
@Component(modules = MatchTimeChildModule.class, dependencies = AppComponent.class)
public interface MatchTimeChildComponent {
    void inject(MatchTimeChildFragment activity);
}