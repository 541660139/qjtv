...
import com.lwd.qjtv.mvp.model.LiveChatModel;
...
public class LiveChatModule {
    ...
    /**
     * 构建LiveChatModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    LiveChatContract.View provideLiveChatView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    LiveChatContract.Model provideLiveChatModel(LiveChatModel model) {
        return model;
    }
}