...
@ActivityScope
@Component(modules = RechargeCostModule.class, dependencies = AppComponent.class)
public interface RechargeCostComponent {
    void inject(RechargeCostFragment activity);
}