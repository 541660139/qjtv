...
@ActivityScope
@Component(modules = WatchRecordeModule.class, dependencies = AppComponent.class)
public interface WatchRecordeComponent {
    void inject(WatchRecordeActivity activity);
}