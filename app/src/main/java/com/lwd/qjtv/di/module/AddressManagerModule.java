...
import com.lwd.qjtv.mvp.model.AddressManagerModel;
...
public class AddressManagerModule {
    ...
    /**
     * 构建AddressManagerModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    AddressManagerContract.View provideAddressManagerView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    AddressManagerContract.Model provideAddressManagerModel(AddressManagerModel model) {
        return model;
    }
}