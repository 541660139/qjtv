...
@ActivityScope
@Component(modules = CommentMessageModule.class, dependencies = AppComponent.class)
public interface CommentMessageComponent {
    void inject(CommentMessageFragment activity);
}