...
import com.lwd.qjtv.mvp.model.MoreModel;
...
public class MoreModule {
    ...
    /**
     * 构建MoreModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    MoreContract.View provideMoreView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    MoreContract.Model provideMoreModel(MoreModel model) {
        return model;
    }
}