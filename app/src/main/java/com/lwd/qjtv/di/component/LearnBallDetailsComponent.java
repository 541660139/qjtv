...
@ActivityScope
@Component(modules = LearnBallDetailsModule.class, dependencies = AppComponent.class)
public interface LearnBallDetailsComponent {
    void inject(LearnBallDetailsActivity activity);
}