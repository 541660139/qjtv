...
@ActivityScope
@Component(modules = VideoChildDetailsModule.class, dependencies = AppComponent.class)
public interface VideoChildDetailsComponent {
    void inject(VideoChildDetailsFragment activity);
}