...
@ActivityScope
@Component(modules = StarIntroduceModule.class, dependencies = AppComponent.class)
public interface StarIntroduceComponent {
    void inject(StarIntroduceFragment activity);
}