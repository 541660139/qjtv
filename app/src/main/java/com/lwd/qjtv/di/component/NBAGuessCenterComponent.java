...
@ActivityScope
@Component(modules = NBAGuessCenterModule.class, dependencies = AppComponent.class)
public interface NBAGuessCenterComponent {
    void inject(NBAGuessCenterActivity activity);
}