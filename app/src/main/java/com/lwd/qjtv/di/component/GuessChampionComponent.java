...
@ActivityScope
@Component(modules = GuessChampionModule.class, dependencies = AppComponent.class)
public interface GuessChampionComponent {
    void inject(GuessChampionActivity activity);
}