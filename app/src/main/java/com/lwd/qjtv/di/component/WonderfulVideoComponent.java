...
@ActivityScope
@Component(modules = WonderfulVideoModule.class, dependencies = AppComponent.class)
public interface WonderfulVideoComponent {
    void inject(WonderfulVideoFragment activity);
}