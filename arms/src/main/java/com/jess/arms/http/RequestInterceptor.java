...
//        if (originalResponse != null)
        bodySize = originalResponse.body().contentLength() != -1 ? originalResponse.body().contentLength() + "-byte" : "unknown-length";
...
//        if (bodySize != null)
    ...
    private String getTag(Request request, String tag) {
        return String.format(" [%s] 「 %s 」--------- %s", request.method(), request.url(), tag);
    }
