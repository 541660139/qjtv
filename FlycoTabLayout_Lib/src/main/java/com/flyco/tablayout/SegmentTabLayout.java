...
//    private GradientDrawable mIndicatorDrawable = new GradientDrawable();
    ...
    private  GradientDrawable mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT,new int[]{Color.red(R.color.white_red),Color.RED});
