...
public abstract class GSYBaseVideoPlayer extends FrameLayout implements GSYMediaPlayerListener {
     ...
     */
    public GSYBaseVideoPlayer startWindowFullscreen(final Context context, final boolean actionBar, final boolean statusBar, boolean isMember, String type) {
        ...
        try {
            ...
            gsyVideoPlayer.getFullscreenButton().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.d(TAG, "onClick: click full screen button");
                }
            });
            ...
            gsyVideoPlayer.getBackButton().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    clearFullscreenLayout();
                    if (listener != null) {
                        listener.onBackButtonClickListen();
                    }
    ...
    /**
     * 当用户为非充值用户时点击back直接退出直播
     */
    public interface BackButtonClickListen {
        void onBackButtonClickListen();
    }


    public void setListener(BackButtonClickListen listener) {
        this.listener = listener;
    }

    public BackButtonClickListen listener;
    ...
    public void clearFullscreenLayout() {
        ...
        if (mOrientationUtils != null) {
            ...
            if (mOrientationUtils != null) {
                ...
                Log.d("GSYVideoPlayer", "clearFullscreenLayout: mOrientationUtils = " + mOrientationUtils);
            }
        }
        mHandler.postDelayed(new Runnable() {
            @Override
    ...
    public abstract boolean setUp(List<GSYVideoModel> gsyVideoModels, int tDuration, boolean cacheWithPlay, int position, File cachePath, Map<String, String> mapHeadData, Object... objects);

    public abstract boolean setUp(List<GSYVideoModel> gsyVideoModels, boolean cacheWithPlay, int position, File cachePath, Map<String, String> mapHeadData, Object... objects);
